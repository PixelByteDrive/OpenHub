if (interaction.customId === "TransferButton") {
  ...
  const SelectMenus = new ActionRowBuilder().addComponents(selectMenu);
  ...
  const modal = new ModalBuilder().setCustomId("myModal").setTitle("Transfer");
  ...
  const ActionRow = new ActionRowBuilder().addComponents(TransferUser);
